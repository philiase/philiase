...
### ☀️ AI Lead Qualification & Booking
...
`n8n` `LLM APIs` `Supabase` `Webhooks` `JSON`

</td>
<td width="50%" valign="top">

### ⚙️ Billing Validation Automation
...
`UiPath` `Python` `Pandas` `OpenPyXL` `Excel`
...
Implemented the open-source Kronos time-series forecasting workflow on financial market data. The work covered data preparation, Python/PyTorch environment setup, inference, forecast visualisation and evaluation using MAE, RMSE and MAPE.

`Python` `PyTorch` `Time Series` `Data Analysis`
...
`Python` `Machine Learning` `Streamlit` `AWS EC2`

[View project →](https://github.com/CaitMc/Team_ES2_Unsupervised_Predict)
